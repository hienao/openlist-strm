package com.hienao.openlist2strm.integration.mvc;
...
import com.hienao.openlist2strm.repository.PermissionRepository;
...
class UserRolePermissionMvcTest {
  ...
  void currentUser_givenValidHttpRequest_shouldSucceedWith200AndReturnJson() throws Exception {
    ...
    stubUser.setId(1L);
    when(userRepository.findByUsername(anyString())).thenReturn(Optional.of(stubUser));
