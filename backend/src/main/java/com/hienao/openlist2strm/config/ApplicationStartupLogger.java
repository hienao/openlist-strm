...
public class ApplicationStartupLogger {
    ...
    public void onApplicationReady() {
        ...
        log.info("📋 活动配置文件: {}", activeProfiles.length > 0 ? String.join(", ", activeProfiles) : "default");
