...
**解决方法**：
请严格按照 **[更新日志中的v1.2.0迁移指南](./update-log.md#v120-重大升级迁移指南)** 进行操作：
...
4. **查看详细迁移指南**
- 完整迁移步骤请参考：[更新日志 - v1.2.0迁移指南](./update-log.md#v120-重大升级迁移指南)
- 包含详细的命令和验证方法
...
3. **参考文档**
   ...
   - 📖 [环境变量配置](./environment-config.md) - 详细的配置说明
